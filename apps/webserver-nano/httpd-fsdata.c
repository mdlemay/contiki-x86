/*********Generated by contiki/tools/makefsdata on 2016-08-04*********/
...
const char data_synth_shtml[23] HTTPD_STRING_ATTR = {
  /* /synth.shtml */
   0x2f, 0x73, 0x79, 0x6e, 0x74, 0x68, 0x2e, 0x73, 0x68, 0x74, 0x6d, 0x6c, 0x00,
   0x25, 0x21, 0x20, 0x73, 0x79, 0x6e, 0x74, 0x68, 0x0d, 0x0a};
...
const struct httpd_fsdata_file     file_synth_shtml[] HTTPD_STRING_ATTR ={{   file_status_shtml, data_synth_shtml   , data_synth_shtml    +13, sizeof(data_synth_shtml)     -13}};
const struct httpd_fsdata_file       file_tcp_shtml[] HTTPD_STRING_ATTR ={{    file_synth_shtml, data_tcp_shtml     , data_tcp_shtml      +11, sizeof(data_tcp_shtml)       -11}};

#define HTTPD_FS_ROOT  file_tcp_shtml
#define HTTPD_FS_NUMFILES  6
#define HTTPD_FS_SIZE 832
